...
public class Main {
    ...
    public static boolean hasSharedDigit(int n, int m) {
        int lastDigit, lastDigit2, lastDigit3, lastDigit4;
        ...
        if (m >= 10 && m <= 99 && n >= 10 && n <= 99) {
            ...
            if (lastDigit == lastDigit3)
                ...
                return true;
            else return lastDigit2 == lastDigit4;
        } else
            return false;
    }
    ...
    public static boolean hasSameLastDigit(int n, int m, int b) {
        ...
        if (isValid(n) && isValid(m) && isValid(b)) {
            lastDigit = n % 10;
            lastDigit2 = m % 10;
            lastDigit3 = b % 10;
            System.out.println(lastDigit);
            ...
            if (lastDigit == lastDigit3)
                ...
                return true;
            else return lastDigit2 == lastDigit;
        } else {
            return false;
        }
    }
    ...
    public static int getGreatestCommonDivisor(int first, int second) {
        if (first < 10 || second < 10) {
            ...
            do {
                ...
                licznik++;
            } while (licznik < first || licznik < second);
            return sum;
        }
    }
